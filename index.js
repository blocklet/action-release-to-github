...
const run = async () => {
  ...
  console.log(`Create release: ${owner}, repo: ${repo}, tag: ${version}`)
  ...
  const link = `https://install.arcblock.io/?action=blocklet-install&meta_url=https%3A%2F%2Fgithub.com%2F${owner}%2F${repo}%2Freleases%2Fdownload%2F${version}%2Fblocklet.json`;
...
`
  if (!regex.test(readme)) {
    ...
    newReadme = readme.replace(regex, `download%2F${version}%2Fblocklet.json`)
  }
